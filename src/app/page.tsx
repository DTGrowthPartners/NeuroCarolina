        ...
        {showPopup && (
          ...
          >
            ...
            >
              ...
              />
              <a
                href={whatsappLink('Hola, me gustaría agendar una cita con NeuroCarolina.')}
                target="_blank"
                rel="noopener noreferrer"
                className="flex w-full items-center justify-center gap-2 rounded-b-xl bg-[#25D366] px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-[#1fb855]"
              >
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <path d="M12 0C5.373 0 0 5.373 0 12c0 2.625.846 5.059 2.284 7.034L.789 23.492a.5.5 0 0 0 .611.611l4.458-1.495A11.952 11.952 0 0 0 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 22c-2.37 0-4.567-.818-6.303-2.187l-.44-.357-2.63.882.882-2.63-.357-.44A9.935 9.935 0 0 1 2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10z"/>
                </svg>
